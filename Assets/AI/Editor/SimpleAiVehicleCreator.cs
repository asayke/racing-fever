...
public class ArcadeAiVehicleCreator : EditorWindow
{
    ...
    {
        ArcadeAiVehicleCreator vehicleCreatorWindow =
            (ArcadeAiVehicleCreator) GetWindow(typeof(ArcadeAiVehicleCreator));
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("Create Vehicle Ai")) createVehicle();
        ...
        if (GUILayout.Button("Adjust Colliders")) adjustColliders();
    }
    ...
    private void adjustColliders()
    {
        ...
        NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("Skid marks FL").position =
            wheelFL.position - Vector3.up * (wheelMesh.bounds.size.y / 2 - 0.02f);
        NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("Skid marks FR").position =
            wheelFR.position - Vector3.up * (wheelMesh.bounds.size.y / 2 - 0.02f);
        NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("Skid marks RL").position =
            wheelRL.position - Vector3.up * (wheelMesh.bounds.size.y / 2 - 0.02f);
        NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("Skid marks RR").position =
            wheelRR.position - Vector3.up * (wheelMesh.bounds.size.y / 2 - 0.02f);
    }
    ...
    private void createVehicle()
    {
        ...
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFL"))
            GameObject.DestroyImmediate(NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFL")
                .Find("WheelFL Axel").GetChild(0).gameObject);
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFR"))
            GameObject.DestroyImmediate(NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFR")
                .Find("WheelFR Axel").GetChild(0).gameObject);
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRL"))
            GameObject.DestroyImmediate(NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRL")
                .Find("WheelRL Axel").GetChild(0).gameObject);
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRR"))
            GameObject.DestroyImmediate(NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRR")
                .Find("WheelRR Axel").GetChild(0).gameObject);
        ...
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFL"))
        {
            ...
            wheelFL.parent = NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFL")
                .Find("WheelFL Axel");
        }
        ...
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFR"))
        {
            ...
            wheelFR.parent = NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelFR")
                .Find("WheelFR Axel");
        }
        ...
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRL"))
        {
            ...
            wheelRL.parent = NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRL")
                .Find("WheelRL Axel");
        }
        ...
        if (NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRR"))
        {
            ...
            wheelRR.parent = NewVehicle.transform.Find("Mesh").transform.Find("Wheels").Find("WheelRR")
                .Find("WheelRR Axel");
        }
    }
}